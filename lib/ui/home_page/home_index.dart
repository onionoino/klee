    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          BaseWidget.getPadding(5),
          BaseWidget.getInstructionTextContainer(Constants.indexPageInstructionText1,
          ...
          BaseWidget.getPadding(5),
          BaseWidget.getInstructionTextContainer(Constants.indexPageInstructionText2,
              MediaQuery.of(context).size.width - 40, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
          BaseWidget.getPadding(5),
          ...
          BaseWidget.getPadding(5),
          BaseWidget.getInstructionTextContainer(Constants.indexPageInstructionText3,
              MediaQuery.of(context).size.width - 40, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
          BaseWidget.getPadding(5),
          ...
          BaseWidget.getPadding(5),
          BaseWidget.getInstructionTextContainer(Constants.indexPageInstructionText4,
              MediaQuery.of(context).size.width - 40, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
