    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          BaseWidget.getInstructionText(Constants.indexPageInstructionText1,
              MediaQuery.of(context).size.width - 30, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
          BaseWidget.getPadding(5),
          BaseWidget.getSubTitleText(Constants.subTitle2),
          BaseWidget.getInstructionText(Constants.indexPageInstructionText2,
              MediaQuery.of(context).size.width - 30, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
          BaseWidget.getPadding(5),
          BaseWidget.getSubTitleText(Constants.subTitle3),
          BaseWidget.getInstructionText(Constants.indexPageInstructionText3,
              MediaQuery.of(context).size.width - 30, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
          BaseWidget.getPadding(5),
          BaseWidget.getSubTitleText(Constants.subTitle4),
          BaseWidget.getInstructionText(Constants.indexPageInstructionText4,
              MediaQuery.of(context).size.width - 30, 30),
          BaseWidget.getPadding(5),
          BaseWidget.getHorizontalLine(MediaQuery.of(context).size.width),
